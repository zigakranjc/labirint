...
function drawImage(){
  ...
  /*  var x = 234;
    ...
    var kvadratek2 = { index: 0, t: 0, speed: 0.03, delay: 0, img: img2, size: 20, stopped: false};
    var kvadratek3 = { index: 0, t: 0, speed: 0.04, delay: 0, img: img3, size: 20, stopped: false};
    var kvadratek4 = { index: 0, t: 0, speed: 0.05, delay: 0, img: img4, size: 20, stopped: false};
    ...
    if (!kvadratek4.stopped && kvadratek1.delay === 0 && kvadratek4.delay === 0) {
        ...
        if (dist < 10) {
            showEndImageUntil = Date.now() + 1500;            
                ...
                kvadratek4.delay = Infinity; // nikoli več se ne aktivira
                requestAnimationFrame(animate);
                return;
            }
    }
